...
def get_excel_sheet(in_file_name: str, sheet_name: str = "Sheet1") -> pe.Sheet:
    book = pe.get_book(file_name=in_file_name)
    sheet1 = book[sheet_name]
    return sheet1

def parse_sheet(sheet: pe.Sheet) -> list:
    """
...
def process_file_json(in_file_name: str, sheet_name: str="Sheet1"):
    """
...
def write_json_to_file(data_json: str, output_file: str):
    """
